...
namespace DBInterface
{
    public class DBConnectorMySQL: IDisposable
    {
                                ...
                                bool persistSecurityInfo, bool integratedSecurity, uint commandTimeout, uint connectionTimeOut)
        {
            ...
            connectionString.DefaultCommandTimeout = commandTimeout;
        ...
        public DBConnectorMySQL(string connString)
        {
        ...
        public void AddParameter(string name, object value, MySqlDbType dbType, ParameterDirection direction = ParameterDirection.Input)
        {
        ...
        public void AddParameters(List<MySqlParameter> parameters)
        {
